...
const PrivacyPolicyPage = () => {
  ...
  return (
    <Article>
      <img src="/assets/logo-pink.png" alt="디스턴스 로고" width={150} />
      <h1>개인정보 처리방침</h1>
      <p>
      ...
      <ol>
        <li>회원가입 및 관리</li>
        <ul>
          <li>[필수] 전화번호, 성별, 소속 학과명, MBTI, 취미, 성격</li>
          <li>
      ...
      <ol>
        ...
        <li>GPS 데이터는 위도·경도로 구성된 실수 정보입니다.</li>
        <ol type="a">
          <li>
      ...
      <h3>개인정보 처리방침 변경</h3>
      <ol>
        <li>이 개인정보 처리방침은 2024. 4. 30.부터 적용됩니다.</li>
      </ol>
      <br />
      <br />
      <br />
